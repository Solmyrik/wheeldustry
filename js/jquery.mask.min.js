      ...
      var d = {
        ...
        getCaret: function () {
          try {
            ...
            if (e && -1 === navigator.appVersion.indexOf('MSIE 10'))
              (a = e.createRange()), a.moveStart('character', -d.val().length), (n = a.text.length);
            else if (k || '0' === k) n = k;
            return n;
          } catch (A) {}
        },
        ...
        events: function () {
          b.on('keydown.mask', function (a) {
            ...
            .on(a.jMaskGlobals.useInput ? 'input.mask' : 'keyup.mask', d.behaviour)
        ...
        getRegexMask: function () {
          ...
          k &&
            (a = a
              .replace(new RegExp('(' + k.digit + '(.*' + k.digit + ')?)'), '($1)?')
        ...
        calculateCaretPosition: function (a, d) {
          ...
          8 === b.data('mask-keycode') && e !== d
            ...
            : e !== d && (a = a >= k ? h : a + (d.slice(0, a).length - e.slice(0, a).length));
          return a;
        },
        ...
        getMasked: function (a, b) {
          ...
          for (var y; u(); ) {
            ...
            if (q)
              t.match(q.pattern)
                ? (c[v](t),
                  q.recursive && (-1 === w ? (w = k) : k === r && (k = w - n), r === w && (k -= n)),
                  (k += n))
                : t === y
                ? (y = void 0)
                : q.optional
